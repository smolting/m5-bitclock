...
void drawNumeric(const char price[], int posX, int posY, image_t *font, Ink_Sprite* sprite, int decimalPlaces)
{
...
void drawDateTime() {
  ...
  char ch_arr[12][4] = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
...
AppState get_app_state(Ink_Sprite* sprite) {
  ...
  if(preferences_exist) state.source = PREFERENCES;
